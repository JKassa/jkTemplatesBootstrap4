...
<ul class="list-group mb-4">
    ...
    <li class="list-group-item">
        <a href="#" data-click="show-modal" data-id="jk-modal_reviews" data-src="{{ reviews_url }}">
            ...
            <span class="badge badge-secondary badge-pill float-right">{{ reviews_quantity }}</span>
        </a>
    </li>
    {% endif %}
	{% if affiliate %}
...
{% endcomment %}
{% capture title_reviews %}{{ '_' | jtext: 'COM_JKASSA_YOUR_REVIEWS' }} <span class="badge badge-secondary">{{ reviews_quantity }}</span>{% endcapture %}
{{ 'renderModal' | bootstrap4: 'jk-modal_reviews', 'modal-lg', title_reviews, '', '', true }}