...
{{ 'startAccordion' | bootstrap4: 'affiliateAccordian' }}
{% if aff_items %}
<!--Transactions-->
{% assign title = '_' | jtext: 'COM_JKASSA_AFFILIATE_TRANSACTIONS' %}
{{ 'addSlide' | bootstrap4: 'affiliateAccordian', title, 'transactions' }}
...
{{ 'addSlide' | bootstrap4: 'affiliateAccordian', title, 'withdrawal' }}
<p>
...
{{ 'addSlide' | bootstrap4: 'affiliateAccordian', title, 'payments' }}
<table class="table table-striped">
	<thead>
		<tr>
			<th>{{ '_' | jtext: 'JDATE' }}</th>
...
{{ 'addSlide' | bootstrap4: 'affiliateAccordian', title_slide, 'banners' }}
