...
<div id="jk-compare-module">
	...
	<div class="mt-2">
		...
		<div class="card mb-1">
			<div class="card-body">
				<a href="#" class="close text-danger" data-click="remove-compare-category" data-indexes="{{ category.indexes }}" title="{{ '_' | jtext: 'MOD_JKASSA_COMPARE_REMOVE' }}">&times;</a>
				<h5 class="card-title">
					{{ category.title }}
				...
				{% else %}
				<a href="{{ category.url }}" class="btn btn-sm btn-secondary">
