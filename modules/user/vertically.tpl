...
<div class="jkassa jk-user-module {{ class_sfx }}">
	...
	<div class="text-center" style="margin-bottom: 10px">
		<div class="btn-group" role="group">
			{% if edit_url %}
			<!--Edit profile-->
			<a class="btn btn-secondary" href="{{ edit_url }}" target="_top" title="{{ '_' | jtext: 'MOD_JKASSA_USER_EDIT_PROFILE' }}">
			...
			{% if logout_url %}
			<!--Log out-->
			<a class="btn btn-secondary" href="{{ logout_url }}" title="{{ '_' | jtext: 'JLOGOUT' }}">
