				...
				<div class="row jk-table-body">
					...
					<div class="col-8">
						...
						<h6 class="card-subtitle mt-1">
							...
							{% endif %}
							<!--remove product-->
							<a href="javascript:;" data-click="remove-product" data-index="{{ product.index }}" data-id="{{ product.id }}" class="hasTooltip" title="{{ '_' | jtext: 'MOD_JKASSA_CART_REMOVE' }}"><i class="fas fa-times text-danger" style="font-size:10px"></i></a>
						</h6>
						{% if product.sku %}
						<!--SKU (code)-->
