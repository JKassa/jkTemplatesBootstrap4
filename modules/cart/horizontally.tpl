...
<div id="jk-cart-module" class="card">
	<ul class="list-unstyled row card-body p-1 m-0">
		...
		<li class="{{ span }}">
			...
			<ol>
				...
				<li>
					...
					<!--remove product-->
					<a href="javascript:;" data-click="remove-product" data-index="{{ product.index }}" data-id="{{ product.id }}" class="hasTooltip" title="{{ '_' | jtext: 'MOD_JKASSA_CART_REMOVE' }}"><span class="fas fa-times text-danger" style="font-size:10px"></span></a>
				</li>
				{% endfor %}
			</ol>
			{% else %}
		...
		<li class="{{ span }}">
			...
			<div class="form-text text-center">
				<!--URL cart-->
				<a class="btn btn-sm btn-secondary mt-1" href="{{ url_cart }}">
