	...
	<div class="col-6 col-sm-3 text-center">
		<div class="input-group qty-product mt-2 p-0 col-4 col-sm-10" style="margin: auto !important">
			<div class="input-group-prepend">
				<a href="javascript:;" class="btn btn-secondary btn-sm" data-click="qty-minus-cart" data-id="{{ product.index }}" class="btn btn-secondary" title="{{ '_' | jtext: 'COM_JKASSA_QTY_BTN' }}">&minus;</a>
			</div>
			...
			<div class="input-group-append">
				<a href="javascript:;" class="btn btn-secondary btn-sm" data-click="qty-plus-cart" data-id="{{ product.index }}" class="btn btn-secondary" title="{{ '_' | jtext: 'COM_JKASSA_QTY_BTN' }}">+</a>
			</div>
		</div>
	</div>
...
<div class="row jk-table-footer">
	...
	<div class="col-12 col-sm-6">
		<div class="row text-right">
			...
			{% if discounts.sav %}
			<!--Discount sav-->
			<div class="col-7"><strong>{{ discounts.sav.name }}:</strong></div>
			<div class="col-5">
			...
			{% if discounts.sum %}
			<!--Discount sum-->
			<div class="col-7"><strong>{{ discounts.sum.name }}:</strong></div>
			<div class="col-5">
			...
			{% if sum_vat %}
			<!--Sum of VAT-->
			<div class="col-7"><strong>{{ '_' | jtext: 'COM_JKASSA_VAT' }}:</strong></div>
			<div class="col-5">
				{{ sum_vat | costDisplay }}{{ currency.symbol }}
			</div>
			{% endif %}
			<!--In total price-->
			<div class="col-12 pt-2" style="border-top:1px solid #dddddd">
