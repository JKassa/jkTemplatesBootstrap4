...
<form action="{{ action }}" method="post" id="mod_jkassa_filter_form">
	<ul class="nav nav-tabs mb-2" id="jkassaFilterTabs" role="tablist">
		{% if filter_cost %}
			{% if active == 'cost' %}
			...
			{% endif %}
		<li class="nav-item">
			<a class="nav-link{{ active_cost }}" id="filterCost-tab" data-toggle="tab" href="#filterCost" role="tab" aria-controls="filterCost" aria-selected="{{ select_cost }}">
		...
		{% if manufacturers %}
			...
			{% endif %}
		<li class="nav-item">
			<a class="nav-link{{ active_man }}" id="filterManufacturers-tab" data-toggle="tab" href="#filterManufacturers" role="tab" aria-controls="filterManufacturers" aria-selected="{{ select_man }}">
		...
		{% if attributes %}
			...
			{% endif %}
		<li class="nav-item">
			<a class="nav-link{{ active_attr }}" id="filterAttributes-tab" data-toggle="tab" href="#filterAttributes" role="tab" aria-controls="filterAttributes" aria-selected="{{ select_attr }}">
	...
	<div class="tab-content" id="jkassaFilterTabsContent">
		...
		<div class="tab-pane fade{% if active == 'cost' %} show active{% endif %}" id="filterCost" role="tabpanel" aria-labelledby="filterCost-tab">
			...
			<div class="row">
				...
				<!--Slider-->
				{% if slider %}
				<div class="col-4 jk-slider-filter">
