...
<h1 class="mb-3">
	{{ heading }}
	<small class="badge badge-secondary">{{ quantity }}</small>
</h1>
{% else %}
<h2 class="mb-3">
	{{ title }}
				...
				<div class="card over-wraper-long">
					...
					<div class="card-body p-2">
						...
						<div class="btn-group mt-2" style="width: 100%">
							...
							{% else %}
							<a href="#" data-click="to-compare-user" data-index="{{ product.index }}" data-id="{{ product.id }}" class="btn btn-sm btn-secondary" title="{{ 'sprintf' | jtext: 'COM_JKASSA_COMPARE_ADD_TITLE', product.name}}">
								<span class="fas fa-random"></span>
							</a>
							{% endif %}
